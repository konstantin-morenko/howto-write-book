...
его помощью (например [автоматическое создание оглавления](FIXME:)) и
...
метод набора](fixme:skills.md#touch-typing).  Но опечатки все равно будут
появляться.
...
написания](fixme:quality-improvement.md).
...
[Структура](fixme:structure.md).  Оглавление по своей сути является
...
- автоматическое создание оглавления позволяет устранить нам саму
  ...
  сказывается на [качестве книги](fixme:quality-management.md);
...
[оглавнении](fixme:idea.md), где описаны разделы, главы и пункты книги,
показывающие *как* сгруппирован материал.  Эта структура вытекает
естественным образом из [ментальной карты](fixme:mindmaps.md), хотя может не
...
формировать [оглавление](fixme:making-toc.md) с номерами страниц в полностью
