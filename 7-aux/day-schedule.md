...
стресс]({{ site.baseurl }}{% link 7-aux/stresses.md %}), иначе книга, если и получится, будет выражать только
...
[вдохновение]({{ site.baseurl }}{% link 5-route/inspiration.md %}), но оно не наступает в процессе стрессовых ситуаций.
...
необходимы [перерывы в работе]({{ site.baseurl }}{% link 7-aux/vacation.md %}) и [перерывы во время работы]({{ site.baseurl }}{% link 6-process/session/breaks.md %}).
...
настроя и [убеждений]({{ site.baseurl }}{% link 5-route/skills-beliefs-values.md %}), но поскольку очень часто приходится совмещать
...
Прогулки по комнате во время [небольших перерывов]({{ site.baseurl }}{% link 6-process/session/breaks.md %}) разгоняют кровь и
