...
Основу книги составляет ее содержание.  Оно, помимо [оформления](FIXME:),
...
[Сбалансированная и несбалансированная структура книги](FIXME:img src="images/balanced-unbalanced-lists.png" alt="Сбалансированная и несбалансированная структура книги")
...
карт](FIXME:mindmaps.md), которые позволяют очень хорошо представить
...
Часто во время [написания](FIXME:text-writing.md) или [редактирования](FIXME:editing.md) текста возникает
...
специфических текстов), что позволяет осуществлять «[Поиск](FIXME:searching.md)» (еще одна
...
написание позволяет осуществлять [поиск](FIXME:searching.md).
...
Цитаты в книге, наравне с [советами](FIXME:tips.md) играют очень важную
...
обозначают ее дух.  В своем проекте [365 дней](FIXME:) я всегда начинал и
...
[советами](FIXME:tips.md), и при должном оформлении придает ему некоторый
[стиль](FIXME:style.md).
...
главу (во время [редактирования](FIXME:editing.md)) и пробуйте описать ее метафорически
...
поддержки](FIXME:help-command.md) для того, чтобы выбрать наиболее интересные из них.  А
...
[Стиль](FIXME:style.md) советов по всему тексту лучше выбирать одинаковым, иначе может
...
научиться пахать читая книги](FIXME:own-efforts.md), так именно упражнения
...
В книге в форме сайте (при [предварительной публикации](FIXME:prepub.md)) ссылки
...
литературы](FIXME:resources.md), который приводится в конце главы или книги.  Сноски в
...
маркировки](FIXME:marks.md) таких мест, который позволит не разрушить
...
объединяет глоссарий с [указателем](FIXME:).  В *простом указателе* термины не
