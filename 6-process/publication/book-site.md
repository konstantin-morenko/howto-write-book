...
почтовом сервисе или на своем [собственном домене](FIXME:domain.md) (что не
...
сетях](FIXME), которые являются «публичными», то есть предназначены именно
для вашей писательской деятельности.


## Перекрестная связь сайта и печатной (электронной) книги

[Перекрестные ссылки](FIXME:cross-links.md) внутри материалов книги служат
...
[продажи книги](FIXME).  Книга полезна тем, что содержит сильно
...
автором](FIXME:site-feedback.md), будь то почта или адрес профиля в
[социальной сети](FIXME).  С таким же успехом эта информация может быть
