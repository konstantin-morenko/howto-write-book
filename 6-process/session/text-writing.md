...
Этот этап процесса самый сложный.  Он требует [«вдохновения»](FIXME:inspiration.md).  Именно
...
в работу](FIXME).  И я стараюсь организовывать *каждый* день по крайней мере
...
По мере формирования структуры книги ее [карта](FIXME:mindmaps.md)
...
В свой [писательский дневник](FIXME) каждый сеанс работы, когда у Вас
...
времени](FIXME), такая статистика позволит предсказать сколько еще тысяч
...
[Структура](FIXME) книги по уровням может выглядеть так:
...
[SMART](FIXME:project.md)), все же это не единственный показатель, поэтому
...
Во-вторых, для того и нужен этап [редактирования](FIXME:editing.md), чтобы
